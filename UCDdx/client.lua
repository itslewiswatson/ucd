...
function drawMessages()
	for index, messageData in pairs(dxMessages) do
		--[[
		dxDrawText(messageData[1], (sX / 1100) * 250 + 1, (sY / 900) * (dxMessagesY[index] * 2) + 1, (sX / 1440) * 1100 + 1, (sY / 900) * 25 + 1, tocolor(0, 0, 0, 255), (sX / 1440) * 1.1, "default-bold", "center", "center", false, true, false)
		dxDrawText(messageData[1], (sX / 1100) * 250 + 1, (sY / 900) * (dxMessagesY[index] * 2) - 1, (sX / 1440) * 1100 + 1, (sY / 900) * 25 - 1, tocolor(0, 0, 0, 255), (sX / 1440) * 1.1, "default-bold", "center", "center", false, true, false)
		dxDrawText(messageData[1], (sX / 1100) * 250 - 1, (sY / 900) * (dxMessagesY[index] * 2) + 1, (sX / 1440) * 1100 - 1, (sY / 900) * 25 + 1, tocolor(0, 0, 0, 255), (sX / 1440) * 1.1, "default-bold", "center", "center", false, true, false)
		dxDrawText(messageData[1], (sX / 1100) * 250 - 1, (sY / 900) * (dxMessagesY[index] * 2) - 1, (sX / 1440) * 1100 - 1, (sY / 900) * 25 - 1, tocolor(0, 0, 0, 255), (sX / 1440) * 1.1, "default-bold", "center", "center", false, true, false)
		dxDrawText(messageData[1], (sX / 1100) * 250, (sY / 900) * (dxMessagesY[index] * 2), (sX / 1440) * 1100, (sY / 900) * 25, tocolor(messageData[2], messageData[3], messageData[4], 255), (sX / 1440) * 1.1, "default-bold", "center", "center", false, true, false)
		--]]
...
function new(message, r, g, b)
	...
	if (dxGetTextWidth(message, (sX / 1440), "default-bold") > 750) then
		output(message:sub(1, 747).."...", 255, 0, 0)
		return
	end
	r, g, b = r or 255, g or 255, b or 255
	if (#dxMessages == 4 or isMoving) then
		Timer(output, 1000, 1, message, r, g, b)
		return
	end
