...
function actualStatistics()
	...
	local convSent = exports.misc:tocomma( sentMegabytes )
	local finalSent = exports.misc:mathround( convSent, 2 )
	
	local receivedBytes = getNetworkStats()[ "bytesReceived" ]
	local receivedMegabytes = convertBytes( receivedBytes )
	local convReceived = exports.misc:tocomma( receivedMegabytes )
	local finalReceived = exports.misc:mathround( convReceived, 2 )
...
exports.misc:centerWindow( netstats.window[ 1 ] )
