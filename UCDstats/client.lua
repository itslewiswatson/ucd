...
function loadStats(data)
	...
	GUIEditor.label[7].text = defaults[7]..tostring(data["wanted"])
	...
	GUIEditor.label[12].text = defaults[12]..tostring(data["kills"])
	GUIEditor.label[13].text = defaults[13]..tostring(data["deaths"])
	GUIEditor.label[14].text = defaults[14]..tostring(data["kdr"])
	GUIEditor.label[15].text = defaults[15]..tostring(data["totalfired"])
