...
addCommandHandler("dx", function () ContextBar.add("The quick brown fox jumps over the lazy dog "..exports.UCDutil:GenerateString(2), math.random(0, 255), math.random(0, 255), math.random(0, 255)) end)
