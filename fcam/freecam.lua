...
function setFreecamEnabled (x, y, z)
	if not (isPedInVehicle(localPlayer)) then
		...
		outputChatBox("You are now in free camera mode! Remember, you can use /freeoff to return back to your skin!", 0, 255, 0)
		...
		exports.NGAdx:createNewDxMessage("You must be on foot to use this command!", 255, 0, 0) end
end
addCommandHandler("free", setFreecamEnabled)
...
addCommandHandler("freeoff", setFreecamDisabled)
...
function getMatrixPos()
	...
	outputChatBox(math.round(X, 3).." "..math.round(Y, 3).." "..math.round(Z, 3).." "..math.round(LX, 3).." "..math.round(LY, 3).." "..math.round(LZ, 3))
end
addCommandHandler("getmatrix", getMatrixPos)
